...
from app.Support.PhoneDisplay import mask_phone, phone_for_ui
from app.Support.Time import utc_now, utc_now_iso

SESSION_TTL_MINUTES = 30

__all__ = ["LoginSession", "SESSION_TTL_MINUTES", "mask_phone", "phone_for_ui"]
...
class LoginSession(Model):
    ...
    def phone_display(self) -> str:
        """Full phone for bot messages (login wizard)."""
        return phone_for_ui(self.get("phone"))

    @property
    def phone_mask(self) -> str:
        """Deprecated alias kept for call-site compatibility; UI uses full number."""
